...
class TissueSegmentation(Dataset):
    def __init__(self, image_dir='data/train_imgs', labels_dir='data/train_labels', input_img_size=(572, 572), output_img_size=(388, 388), print_dataset=False):
        X = []
        y = []
    ...
    def __getitem__(self, index):
        ...
        labels = cv2.resize(labels, self.output_img_size, interpolation=cv2.INTER_NEAREST)
...
if __name__ == '__main__':
    dataloader = get_dataloader(image_dir='data/train_imgs', labels_dir='data/train_labels', print_dataset=True, batch_size=8, input_img_size=(572, 572), output_img_size=(388, 388))
